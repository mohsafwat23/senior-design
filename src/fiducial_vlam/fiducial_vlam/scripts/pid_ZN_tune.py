...
class LandingNode(Node):
    ...
    def __init__(self):
        ...
        self.kd_xyz = np.array([0.1, 0.1, 0.1])
        ...
        self.mobrob_subscription = self.create_subscription(
        Odometry, 
        "/platform_robot/odom_platform_robot", 
        self.mobrob_pose_subscriber, 
        1)
        self.mobrob_subscription # prevent unused variable warning
    ...
    def mobrob_pose_subscriber(self, msg):
        """This callback function gets the position of the mobile robot"""
        self.mobrob_x = msg.pose.pose.position.x
        self.mobrob_y = msg.pose.pose.position.y
        self.mobrob_z = msg.pose.pose.position.z
